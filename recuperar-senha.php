...
if($total_reg > 0){    
    ...
    // COMO É SERVIDOR LOCAL, NÃO SERA ENVIADO PARA O E-MAIL.
    @mail($destinatario, $assunto, $mensagem, $cabecalhos);

    /*PARA VERIFICAR SE O LINK FOI CRIADO E ESTA FUNCIONANDO, 
    DESCOMENTE O CÓDIGO ABAIXO. ACESSE O LINK, E ALTERE A SENHA.*/
    //echo $reset_link;
    //exit();
